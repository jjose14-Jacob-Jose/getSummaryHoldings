    ...
    return (
        <main className="p-12 items-center align-middle justify-center">
            ...
            <div className="flex gap-2 p-2">
                <h1><a href="/"> Get Summary Holdings </a></h1>
                Contact us:
                <a href="mailto:support@getsummaryholdings.com">support@getsummaryholdings.com</a>
            </div>
            ...
            <div id="tableUserInput" >
                <form action="http://localhost:8080/postData" method="POST" id="formUserInput">
                    ...
                    <label id="lblTxtNumberYearStarting" htmlFor ="txtNumberYearStarting">Starting Year:</label>
                    <input type="text" id="txtNumberYearStarting" name="yearStarting" required placeholder="Earliest edition in Alma"   />
                    <label id="lblTxtNumberYearEnding" htmlFor ="txtNumberYearEnding" className="text-right">End Year:</label>
                    <input type="text" id="txtNumberYearEnding" name="yearEnding" required placeholder="Latest edition in Alma or 2020" value="2020"  />
                
                    <label id="lblTxtNumberEditionsPerYear" htmlFor ="txtNumberEditionsPerYear">Editions in a year:</label>
                    <input type="text" id="txtNumberEditionsPerYear" name="editionsPerYear" required placeholder="Number of issues in a year" value="12"  />
                    <label id="lblTxtNumberVolumeStartingYear" htmlFor ="txtNumberVolumeStartingYear">Volume of starting year:</label>
                    <input type="text" id="txtNumberVolumeStartingYear" name="volumeStartingYear" required placeholder="Volume of starting year" value="1"  />
  
                    <button id="btnCreateTable" className="p-1 px-4 bg-slate-500 rounded-md text-white">Generate Checkboxes</button>
                    ...
                    <div colSpan="2">
                        ...
                        <button type="submit" id="btnGenerateSummary" className="p-1 px-4 bg-slate-500 rounded-md text-white">Generate Summary Holdings</button>
            
                    </div>
                
                </form>
                    
                <button id="btnClearAll" className="p-1 px-4 bg-slate-500 rounded-md text-white">Reset</button>
            ...
            <div id="divUserGuide">
                ...
                <h3>User Guide</h3>
                <ol>
                    <li>'Generate Checkboxes to generate a new checkbox-div. This will also to clear existing data.</li>
