  ...
  return (
    <div className="items-center align-middle justify-center text-center lg:text-left">
      ...
      <div id="learnMoreSection">
        ...
        <div className="px-6  mobile:px-12 pt-28 pb-28 mx-auto justify-center items-center bg-[#1E2027] ">
          ...
          <div className="xl:flex mx-auto justify-center xl:space-x-20 space-y-10 xl:space-y-0 mt-10">
            <div className=" xl:w-1/3 hover:bg-[#292D3A] hover:shadow-2xl xl:space-y-0 space-y-10 border border-[#1E2027]  rounded-2xl pb-12 xl:p-4 ">
              <div className="flex mx-auto justify-center">
                <img
            ...
            <div className=" xl:w-1/3 hover:bg-[#292D3A]  hover:shadow-2xl border border-[#1E2027] rounded-2xl pb-12 pt-6 xl:p-12">
        ...
        {/* Contact section */}
        <div className="px-6 mobile:px-12 pt-28 pb-28 gap-24 mx-auto flex justify-center text-center bg-[#1E2027] items-center h-[400px]">
          <div>
            <h1
