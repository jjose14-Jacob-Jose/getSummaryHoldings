            ...
            <div className="flex gap-4 justify-center items-center align-bottom text-[#515151]">
                <div className="flex gap-6 pr-4">
                    ...
                    <div className="max-w-[133px] w-fit">
                        ...
                        <input type="number" min="1" id="txtNumberEditionsPerYear" className="text-black mt-1 font-light p-1 pl-[10px] text-sm border-black/[0.2] border-[1.5px] rounded max-w-[133px]" name="editionsPerYear" required defaultValue="7" />
                    </div>
